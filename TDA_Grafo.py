...
def dijkstra_distancia(grafo, origen, destino):
    ...
    while(not heap_vacio(no_visitados)):
        ...
        while(aux is not None):
            pos = buscar_h(no_visitados, aux.destino)
            if(no_visitados.vector[pos][0] > dato[0] + aux.info[5]): #Compara por el campo distancia de la aristag
...
def dijkstra_duracion(grafo, origen, destino):
    ...
    while(not heap_vacio(no_visitados)):
        ...
        while(aux is not None):
            pos = buscar_h(no_visitados, aux.destino)
            if(no_visitados.vector[pos][0] > dato[0] + aux.info[4]): #Compara por el campo duracion de la aristag
...
def dijkstra_costo(grafo, origen, destino):
    ...
    while(not heap_vacio(no_visitados)):
        ...
        while(aux is not None):
            pos = buscar_h(no_visitados, aux.destino)
            if(no_visitados.vector[pos][0] > dato[0] + aux.info[4]): #Compara por el campo costo de la aristag
                no_visitados.vector[pos][1][1] = dato[1][0].info[4]
                cambiar_prioridad(no_visitados, pos, dato[0] + aux.info[4])
            aux = aux.sig
    return camino
